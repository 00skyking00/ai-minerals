...
label-choice decision barely moves the model, which is reassuring for v1.
...
verifying that the result does not hinge on the label-class definition
(family vs strict).
...
## What Eastern Alaska actually demonstrates
