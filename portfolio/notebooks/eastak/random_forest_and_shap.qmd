...
`docs/mvp-proposal.md`). This notebook answers four of them with
...
*count*. This is the mineral-system signal, not exploration effort.
...
- **Exploration-bias confound confirmed and removed**: the `*_count_5km`
  ...
  and let the model rest on geochemistry instead of sampling effort.
...
- **Top 1% captures 64% of known positives; top 5% captures 100%**
  (training-set predictions; the spatial-CV AUC that holds out blocks is
  0.88).
