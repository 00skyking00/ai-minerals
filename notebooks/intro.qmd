...
#
# A sensitivity comparison runs after Day-5 validation: report whether
...
only a few dozen are confirmed deposits. Day 3 addresses this directly
(pseudo-negative sampling + PU-learning comparison). After Day 5 we'll
