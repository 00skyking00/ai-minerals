...
We have a 2° × 6° patch of eastern Alaska — three contiguous 1:250,000
quadrangles (Tanacross, Mt Hayes, Nabesna) spanning the Wrangellia–
Yukon-Tanana tectonic boundary — and we want to build a model that says
"**this pixel is more likely to host a porphyry copper deposit than that
pixel**." That's mineral prospectivity mapping.
