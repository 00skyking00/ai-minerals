...
#
# Usage:
#   scripts/northern_sierra_placer_audit_suite.sh
set -euo pipefail
...
$PY scripts/northern_sierra_placer_calibration_audit.py

section "F.2.2 lindgren_blind_set.py"
$PY scripts/northern_sierra_placer_lindgren_blind_set.py

section "F.2.3 north_south_split.py"
$PY scripts/northern_sierra_placer_north_south_split.py

section "F.2.4 rationale_250m.py (capped 12G / swap 0)"
$CAPPED -- $PY scripts/northern_sierra_placer_rationale_250m.py

section "F.2.5 leakage_risk_audit.py"
$PY scripts/northern_sierra_placer_leakage_risk_audit.py

section "F.2.6 validation.py (capped 12G / swap 0)"
$CAPPED -- $PY scripts/northern_sierra_placer_validation.py
