...
#
# Usage:
#   bash scripts/northern_sierra_placer_reproducibility_check.sh
...
if [[ "${FAIL}" -gt 0 ]]; then
  ...
  echo "    python scripts/northern_sierra_placer_fetch_all.py"
  echo "    python scripts/northern_sierra_placer_precompute_paleochannel.py"
  echo "    python scripts/northern_sierra_placer_assemble_250m.py"
  echo "    python scripts/northern_sierra_placer_phase1_index.py --check-anchors-top-decile"
  echo "    python scripts/northern_sierra_placer_train_predict_250m.py"
  echo "    python scripts/northern_sierra_placer_calibrate_and_fuse.py"
  echo "    python scripts/northern_sierra_placer_calibration_audit.py"
  echo "    python scripts/northern_sierra_placer_lindgren_blind_set.py"
  echo "    python scripts/northern_sierra_placer_north_south_split.py"
  echo "    python scripts/northern_sierra_placer_calaveras_transfer.py"
  echo "    python scripts/northern_sierra_placer_validation.py"
  exit 1
fi
