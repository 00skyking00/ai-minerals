...
Usage:
    .venv/bin/python scripts/northern_sierra_placer/assemble_250m.py
    .venv/bin/python scripts/northern_sierra_placer/assemble_250m.py --resolution-m 500
    .venv/bin/python scripts/northern_sierra_placer/assemble_250m.py --augment-osm-mining
...
`scripts/northern_sierra_placer/fetch_osm_mining.py` for the fetcher.
"""
    ...
    if augment_osm_mining:
        ...
        if osm_path.exists():
            ...
            print(f"[assemble]   OSM mining augmentation requested but file not "
                  ...
                  f"scripts/northern_sierra_placer/fetch_osm_mining.py first.")
...
def _inject_v37_quaternary_kernel(
    ...
    *,
    ...
    `scripts/northern_sierra_placer/relabel_motherlode.py` and joins by
    ...
    *,
    ...
    `placer_version`:
      ...
      - "v37": Tertiary unchanged from v3.6; Quaternary swapped from
        ...
        by scripts/northern_sierra_placer/relabel_motherlode.py.
    ...
    if placer_version == "v37":
        if v37_kernel_parquet is None or not v37_kernel_parquet.exists():
            raise FileNotFoundError(
                ...
                f"scripts/northern_sierra_placer/relabel_motherlode.py first."
            )
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "scripts/northern_sierra_placer/fetch_osm_mining.py. License: "
