...
Usage:
    .venv/bin/python scripts/northern_sierra_placer/fetch_all.py
    .venv/bin/python scripts/northern_sierra_placer/fetch_all.py --only nhdplus_hr
    .venv/bin/python scripts/northern_sierra_placer/fetch_all.py --skip threedep,nhdplus_hr
"""
