...
Usage:
    .venv/bin/python scripts/northern_sierra_placer/phase1_index.py
    .venv/bin/python scripts/northern_sierra_placer/phase1_index.py --check-anchors-top-decile
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    if not args.features.exists():
        print(f"ERROR: features parquet not found at {args.features}.\n"
              f"Run scripts/northern_sierra_placer/assemble_250m.py first (Phase E).",
              file=sys.stderr)
        return 2
