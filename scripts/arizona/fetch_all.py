...
Mirrors `scripts/cross_region/klamath_fetch_all.py`. Reuses the same source data
...
After this runs, follow with:
  scripts/arizona/features.py     (build feature frame)
  scripts/arizona/decompose.py    (ILR-PCA + GLCM, parallel to Path 5 Stage A)
  scripts/arizona/oof_comparison.py (DevNet + RF OOF)
"""
