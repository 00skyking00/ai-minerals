...
Mirrors `scripts/arizona_fetch_all.py`. Bear Lodge sits in NE Wyoming
...
After this runs, follow with:
  scripts/bear_lodge_features.py
  scripts/bear_lodge_decompose_features.py
  scripts/bear_lodge_devnet.py
"""
